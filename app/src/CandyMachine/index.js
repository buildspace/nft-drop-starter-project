...
const CandyMachine = ({ walletAddress }) => {
        ...
        async (notification, context) => {
          if (notification.type === "status") {
            ...
            if (!result.err) {
              ...
              // Set flag to false as our NFT has been minted!
              setIsMinting(false);
  ...
  const getCandyMachineState = async () => {
    try {
      ...
      // Set the data to your state to render
      setMachineStats({
        itemsAvailable,
        itemsRedeemed,
        itemsRemaining,
  ...
  return (
    ...
    machineStats && (
      <div className="machine-container">
        {renderDropTimer()}
        <p>{`Legends Minted: ${machineStats.itemsRedeemed} / ${machineStats.itemsAvailable}`}</p>
